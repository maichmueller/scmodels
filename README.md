...
|    |         Z |            X |         Y |          V |         W |
|----|-----------|--------------|-----------|------------|-----------|
|  0 | 0.199479  |    0.386857  |  3.25358  |    1.38686 |  2.09638  |
|  1 | 9.53959   | 4632.13      | 89.6861   | 4631.96    | 89.8337   |
|  2 | 1.70949   |   44.3514    | 10.8828   |   45.3222  | 11.4667   |
|  3 | 2.33079   |   62.013     | 14.5727   |   62.7734  | 14.5593   |
|  4 | 0.0458014 |    0.0118569 | -0.224322 |    1.58168 |  0.823098 |
...
display_df(pd.DataFrame.from_dict(container))
```


|    |         Z |           X |        Y |          V |         W |
|----|-----------|-------------|----------|------------|-----------|
|  0 |  0.200184 |    0.718512 |  4.47804 |    1.71851 |   1.48689 |
|  1 |  5.56781  | 3949.26     | 76.2768  | 3950.87    |  72.8065  |
|  2 |  2.58224  |   33.215    | 12.5632  |   34.6304  |  -2.1592  |
|  3 |  0.698663 |    3.10964  |  4.65802 |    4.10964 |   7.23014 |
|  4 | 14.3715   | 2599.18     | 82.1981  | 2599.51    | 126.82    |
...
display_df(pd.DataFrame.from_dict(sample))
```


|    |       Z |       X |       Y |       V |       W |
|----|---------|---------|---------|---------|---------|
|  0 | 1.86445 | 273.492 | 22.9861 | 274.492 | 23.3474 |

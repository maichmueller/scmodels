...
def build_scm_simple(seed=0):
    cn = SCM(
        assignment_map={
            ...
            "X_3": (["X_1"], "0.3 * X_1 + N", Normal("N", 0, 1),),
            "Y": (["X_3"], "3 + 5 * X_3 + N", Normal("N", 0, 1),),
            "X_4": (["Y"], "3 + 9 * Y + N", Normal("N", 0, 1),),
            "X_5": (["X_3"], "3 - 2.7 * X_3 + N", Normal("N", 0, 1),),
        },
        variable_tex_names={
            "X_0": "$X_0$",
            "X_1": "$X_1$",
...
def build_scm_medium(seed=0):
    cn = SCM(
        assignment_map={
            ...
            "X_3": (["X_1", "X_2"], "N + 1 + 0.3 X_1 + 0.4 X_2", Normal("N", 0, 1),),
            "Y": (["X_3", "X_0"], "N + 0.67 + X_3 - X_0", Normal("N", 0, 1),),
            "X_4": (["Y"], "N + 1.2 - 0.7 * Y", Normal("N", 0, 1),),
            "X_5": (["X_3", "Y"], "N + 0.5 - 0.7 * Y", Normal("N", 0, 1),),
        },
        variable_tex_names={
            "X_0": "$X_0$",
            "X_1": "$X_1$",
...
def build_scm_linandpoly(seed=0):
    cn = SCM(
        assignment_map={
            ...
            "Y": (["X_0", "X_2"], "N + 0.05 * X_0 ** 2 + 2 * X_2", Normal("N", 0, 1)),
        },
        variable_tex_names={
            "X_0": "$X_0$",
            "X_1": "$X_1$",
